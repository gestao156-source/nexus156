      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Novo Ponto de Contato</h2>
              <p className="text-sm text-gray-600">Crie um novo ponto de contato padrão</p>
            </div>
          </div>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <p className="text-sm font-medium text-gray-700 mb-2">Exemplos de pontos de contato:</p>
            <div className="space-y-1">
              <button
                type="button"
                onClick={() => setNome('Naruto')}
                className="block w-full text-left text-xs text-gray-600 hover:text-purple-600 transition-colors py-1"
              >
                • Naruto
              </button>
              <button
