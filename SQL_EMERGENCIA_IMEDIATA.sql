-- EMERGÊNCIA IMEDIATA: DESATIVAR TRIGGERS DE NOTIFICAÇÃO
-- Isso vai restaurar a funcionalidade de salvar solicitacoes/demandas

-- Remover todos os triggers de notificação que estão quebrando o sistema
