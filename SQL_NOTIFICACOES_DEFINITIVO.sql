-- Sistema de Notificações Nexus156 - VERSÃO FINAL 100% CORRIGIDA
...
-- Função para criar notificação (RPC) - SINTAXE CORRIGIDA
...
-- Função para marcar notificação como lida (RPC) - SINTAXE CORRIGIDA
...
-- Função para marcar todas como lidas (RPC) - SINTAXE CORRIGIDA
...
-- Função para obter notificações do usuário (RPC) - SINTAXE CORRIGIDA
...
-- Função para contar notificações não lidas (RPC) - SINTAXE CORRIGIDA
